  ...
  return (
    <>
      <div class="flex flex-col min-h-screen">
        <section class="bg-white dark:bg-gray-800 py-12 md:py-16">
          <div class="container mx-auto px-4 md:px-6 lg:px-8">
            <h2 class="text-2xl md:text-3xl font-bold text-gray-900 dark:text-gray-50 mb-8">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              >
                ...
                <div class="p-6">
                  ...
                  <a
                    class="inline-flex items-center justify-center px-4 py-2 bg-red-500 hover:bg-red-600 text-white font-medium rounded-md transition-colors duration-300 mt-4"
                    href="#"
                  >
                    Register
                  </a>
