...
const EditBloodBank = () => {
  ...
  const [bbImage, setBloodBankImage] = useState(null); // State to hold the image preview URL
  ...
  useEffect(() => {
    fetchSingleBloodBankApi(id).then((res) => {
      ...
      setOperatingHours(res.data.bloodbank.oHours);
      setAvailableBloodGroups(res.data.bloodbank.bgavailable);
      ...
      setSocialMediaLinks(res.data.bloodbank.socialLinks);
